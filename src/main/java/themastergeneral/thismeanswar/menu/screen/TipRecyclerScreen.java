...
public class TipRecyclerScreen extends AbstractContainerScreen<TipRecyclerMenu> {
	...
	private static final ResourceLocation TEXTURE = new ResourceLocation(TMWMain.MODID, "textures/gui/tip_recycler.png");
	
	public TipRecyclerScreen(TipRecyclerMenu menu, Inventory p_97742_, Component p_97743_) 
	{
