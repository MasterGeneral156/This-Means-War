...
public class MolderScreen extends AbstractContainerScreen<MolderMenu> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(TMWMain.MODID, "textures/gui/molder.png");
	
	public MolderScreen(MolderMenu menu, Inventory p_97742_, Component p_97743_) 
	{
	...
	protected void renderLabels(GuiGraphics guigfx, int x, int y) {
        ...
        if (errorCode > 0)
        	guigfx.drawString(this.font, ModUtils.displayTranslation("thismeanswar.container.molder.error." + errorCode), 84, 44, 4210752, false);
    }
