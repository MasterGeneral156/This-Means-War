...
public class PressScreen extends AbstractContainerScreen<PressMenu> {
	...
	private static final ResourceLocation TEXTURE = new ResourceLocation(TMWMain.MODID, "textures/gui/press.png");
	
	public PressScreen(PressMenu menu, Inventory p_97742_, Component p_97743_) 
	{
