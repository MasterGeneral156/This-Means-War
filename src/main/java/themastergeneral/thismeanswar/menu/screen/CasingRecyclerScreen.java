...
public class CasingRecyclerScreen extends AbstractContainerScreen<CasingRecyclerMenu> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(TMWMain.MODID, "textures/gui/casing_recycler.png");
	
	public CasingRecyclerScreen(CasingRecyclerMenu menu, Inventory p_97742_, Component p_97743_) 
	{
