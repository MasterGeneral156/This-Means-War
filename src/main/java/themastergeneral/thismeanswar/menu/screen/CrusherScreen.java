...
public class CrusherScreen extends AbstractContainerScreen<CrusherMenu> {
	...
	private static final ResourceLocation TEXTURE = new ResourceLocation(TMWMain.MODID, "textures/gui/crusher.png");
	
	public CrusherScreen(CrusherMenu menu, Inventory p_97742_, Component p_97743_) 
	{
