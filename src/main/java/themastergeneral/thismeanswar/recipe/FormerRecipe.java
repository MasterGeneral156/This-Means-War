...
public class FormerRecipe implements Recipe<Container> {
   ...
   public FormerRecipe(ResourceLocation p_267143_, Ingredient p_266787_, Ingredient ingredient2, ItemStack p_267031_) {
      this.id = p_267143_;
      this.base = p_266787_;
   ...
   public RecipeSerializer<?> getSerializer() {
      return TMWRecipeTypeRegistration.CASING_FORMER.get();
   }
   ...
   public RecipeType<FormerRecipe> getType() {
       ...
       return TMWRecipeTypeRegistration.FORMER_TYPE.get();
   }
   ...
   public static class Serializer implements RecipeSerializer<FormerRecipe> {
      public FormerRecipe fromJson(ResourceLocation p_266953_, JsonObject p_266720_) {
         ...
         return new FormerRecipe(p_266953_, ingredient1, ingredient2, itemstack);
      }

      public FormerRecipe fromNetwork(ResourceLocation p_267117_, FriendlyByteBuf p_267316_) {
         ...
         return new FormerRecipe(p_267117_, ingredient1, ingredient2, itemstack);
      }

      public void toNetwork(FriendlyByteBuf p_266746_, FormerRecipe p_266927_) {
