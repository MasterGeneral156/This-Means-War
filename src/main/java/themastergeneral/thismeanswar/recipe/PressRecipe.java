...
public class PressRecipe implements Recipe<Container> {
   ...
   public PressRecipe(ResourceLocation p_267143_, Ingredient p_266787_, ItemStack p_267031_) {
      this.id = p_267143_;
      this.base = p_266787_;
   ...
   public static class Serializer implements RecipeSerializer<PressRecipe> {
      public PressRecipe fromJson(ResourceLocation p_266953_, JsonObject p_266720_) {
         ...
         return new PressRecipe(p_266953_, ingredient1, itemstack);
      }

      public PressRecipe fromNetwork(ResourceLocation p_267117_, FriendlyByteBuf p_267316_) {
         Ingredient ingredient1 = Ingredient.fromNetwork(p_267316_);
         ItemStack itemstack = p_267316_.readItem();
         return new PressRecipe(p_267117_, ingredient1, itemstack);
      }

      public void toNetwork(FriendlyByteBuf p_266746_, PressRecipe p_266927_) {
