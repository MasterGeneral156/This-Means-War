...
public class ReprocessorRecipe implements Recipe<Container> {
	
   private final ResourceLocation id;
   final Ingredient base;
   final ItemStack result;

   public ReprocessorRecipe(ResourceLocation p_267143_, Ingredient p_266787_, ItemStack p_267031_) {
      this.id = p_267143_;
      this.base = p_266787_;
   ...
   public RecipeSerializer<?> getSerializer() {
      return TMWRecipeTypeRegistration.REPROCESSOR.get();
   }
   ...
   public RecipeType<ReprocessorRecipe> getType() {
       ...
       return TMWRecipeTypeRegistration.REPROCESSOR_TYPE.get();
   }
   ...
   public static class Serializer implements RecipeSerializer<ReprocessorRecipe> {
      public ReprocessorRecipe fromJson(ResourceLocation p_266953_, JsonObject p_266720_) {
         ...
         return new ReprocessorRecipe(p_266953_, ingredient1, itemstack);
      }

      public ReprocessorRecipe fromNetwork(ResourceLocation p_267117_, FriendlyByteBuf p_267316_) {
         Ingredient ingredient1 = Ingredient.fromNetwork(p_267316_);
         ItemStack itemstack = p_267316_.readItem();
         return new ReprocessorRecipe(p_267117_, ingredient1, itemstack);
      }

      public void toNetwork(FriendlyByteBuf p_266746_, ReprocessorRecipe p_266927_) {
