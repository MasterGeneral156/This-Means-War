...
public class MolderRecipe implements Recipe<Container> {
   ...
   public MolderRecipe(ResourceLocation p_267143_, Ingredient p_266787_, Ingredient ingredient2, ItemStack p_267031_) {
      this.id = p_267143_;
      this.base = p_266787_;
   ...
   public RecipeSerializer<?> getSerializer() {
      return TMWRecipeTypeRegistration.TIP_MOLDER.get();
   }
   ...
   @Override
   public RecipeType<MolderRecipe> getType() {
       // Return an instance of your recipe type
       return TMWRecipeTypeRegistration.MOLDER_TYPE.get();
   }
   ...
   public static class Serializer implements RecipeSerializer<MolderRecipe> {
      public MolderRecipe fromJson(ResourceLocation p_266953_, JsonObject p_266720_) {
         Ingredient ingredient1 = Ingredient.fromJson(GsonHelper.getNonNull(p_266720_, "base"));
         Ingredient ingredient2 = Ingredient.fromJson(GsonHelper.getNonNull(p_266720_, "cast"));
         ItemStack itemstack = ShapedRecipe.itemStackFromJson(GsonHelper.getAsJsonObject(p_266720_, "result"));
         return new MolderRecipe(p_266953_, ingredient1, ingredient2, itemstack);
      }

      public MolderRecipe fromNetwork(ResourceLocation p_267117_, FriendlyByteBuf p_267316_) {
         ...
         return new MolderRecipe(p_267117_, ingredient1, ingredient2, itemstack);
      }

      public void toNetwork(FriendlyByteBuf p_266746_, MolderRecipe p_266927_) {
