...
public class PopperRecipe implements Recipe<Container> {
   ...
   public PopperRecipe(ResourceLocation p_267143_, Ingredient p_266787_, Ingredient ingredient2, ItemStack p_267031_) {
      this.id = p_267143_;
      this.base = p_266787_;
   ...
   public RecipeSerializer<?> getSerializer() {
      return TMWRecipeTypeRegistration.POPPER.get();
   }
   ...
   @Override
   public RecipeType<PopperRecipe> getType() {
       // Return an instance of your recipe type
       return TMWRecipeTypeRegistration.POPPER_TYPE.get();
   }
   ...
   public static class Serializer implements RecipeSerializer<PopperRecipe> {
      public PopperRecipe fromJson(ResourceLocation p_266953_, JsonObject p_266720_) {
         ...
         return new PopperRecipe(p_266953_, ingredient1, ingredient2, itemstack);
      }

      public PopperRecipe fromNetwork(ResourceLocation p_267117_, FriendlyByteBuf p_267316_) {
         ...
         return new PopperRecipe(p_267117_, ingredient1, ingredient2, itemstack);
      }
